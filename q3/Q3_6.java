...
public class Q3_6 extends JFrame {
	...
	public Q3_6() {
		...
		comboBox.addItem(new Q3_Combo("Jaffna", 0));
		comboBox.addItem(new Q3_Combo("Kilinochchi", 1));
		comboBox.addItem(new Q3_Combo("Vavuniya", 2));
		comboBox.addItem(new Q3_Combo("Colombo", 3));
		
		JComboBox<Object> comboBox_1 = new JComboBox<Object>();
		comboBox_1.setBounds(182, 101, 75, 20);
		contentPane.add(comboBox_1);
		comboBox_1.addItem(new Q3_Combo("Jaffna", 0));
		comboBox_1.addItem(new Q3_Combo("Kilinochchi", 1));
		comboBox_1.addItem(new Q3_Combo("Vavuniya", 2));
		comboBox_1.addItem(new Q3_Combo("Colombo", 3));
		...
		btnGetDistance.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int value1 = ((Q3_Combo)item1).getValue();
				String key1 = ((Q3_Combo)item1).getKey();
				
				Object item2 = comboBox_1.getSelectedItem();
				int value2 = ((Q3_Combo)item2).getValue();
				String key2 = ((Q3_Combo)item2).getKey();
				
				lblNewLabel_1.setText(key1);
				label.setText(key2);
				
				label_1.setText(Integer.toString(Q3_5.getDistance(value1, value2)));
